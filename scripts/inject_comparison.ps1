$p = "c:\Users\SS\slurry\src\app\(app)\reports\page.tsx"
$lines = [System.IO.File]::ReadAllLines($p, [System.Text.Encoding]::UTF8)
$before = $lines[0..2057]
$after  = $lines[2135..($lines.Count-1)]
$newBlock = @'
...
[System.IO.File]::WriteAllLines($p, $result, [System.Text.UTF8Encoding]::new($false))
